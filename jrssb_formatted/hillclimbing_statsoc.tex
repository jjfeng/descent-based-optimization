...
The results show that the generalized APLM criterion had better performance in most cases. The linear model fits improved the most, which supports our hypothesis.
