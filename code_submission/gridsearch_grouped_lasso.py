...
def run(X_train, y_train, X_validate, y_validate, group_feature_sizes, num_lambdas=10):
    infty_norm = 0
    start_feature = 0
    ...
    # Generate the lambdas for grid search over
...
def run_classify(X_groups_train, y_train, X_groups_validate, y_validate, num_lambdas=8):
    """
...
def run_classify_fullcv(X_groups_train_validate, y_train_validate, feature_group_sizes, kfolds, num_lambdas=5):
    """
    Runs a logistic regression instead
    """
