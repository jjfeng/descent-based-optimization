...
\begin{lemma}
For some $\lambda_0$, assume that the non-active set of $\hat f(\lambda_0)$ is locally constant in a neighborhood around $\lambda_0$ and assume that the regularity conditions in lemma \ref{differentiablethrm} hold for the active set of $\hat f(\lambda_0)$. Then $\hat f(\lambda)$ is continuously differentiable in some neighborhood around $\lambda_0$.
\label{activesetthrm}
\end{lemma}
