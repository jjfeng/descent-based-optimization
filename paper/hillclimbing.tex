...
\label{alg:basic}
        ...
        \begin{itemize}
        \item[] Perform gradient step with step size $t^{(k)}$
	\begin{equation}
  ...
  \label{alg:gradDescent}
		...
		\right ]
	     	\label{gradientCalculation}
              ...
              \item[] Perform the gradient update with step size $t^{(k)}$
	\begin{equation*}
...
\begin{equation}
\begin{array}{c}
\min_{\lambda\in \mathbb{R}} \frac{1}{2} \| \boldsymbol{y}_V - \boldsymbol{X}_V \hat{\boldsymbol{\theta}} (\lambda) \|_2 ^2 \\
...
\begin{equation}
\begin{array}{c}
\min_{\boldsymbol{\lambda} \in \mathbb{R}^2} \frac{1}{2} \| \boldsymbol{y}_V - \boldsymbol{X}_V \hat{\boldsymbol{\theta}} (\lambda) \| ^2 \\
\text{ where }
...
\begin{equation}
\begin{array}{c}
\min_{\boldsymbol{\lambda} \in \mathbb{R}^2} \frac{1}{2} \| \boldsymbol{y}_V - \boldsymbol{X}_V \boldsymbol{I}_{I(\boldsymbol \lambda)} \hat{\boldsymbol{\beta}} (\lambda) \| ^2 \\
\text{ where }
...
\begin{equation}
\begin{array}{c}
\min_{\boldsymbol{\lambda} \in \mathbb{R}^2} \frac{1}{2} \| \boldsymbol{y}_V - \boldsymbol{X}_{V, I(\boldsymbol \lambda)} \hat{\boldsymbol{\beta}} (\lambda) \| ^2 \\
\text{ where }
...
\begin{equation}
\begin{array}{c}
\min_{\boldsymbol{\lambda} \in \mathbb{R}^2} \frac{1}{2n}
...
\begin{equation}
\begin{array}{c}
\min_{\boldsymbol{\lambda} \in \mathbb{R}^2} \frac{1}{2n} \left \| \boldsymbol{y}_V - X_{V,I(\boldsymbol\lambda)} \hat{\boldsymbol\beta}(\boldsymbol{\lambda}) \right \|^2_2 \\
\text{ where }
...
\begin{equation}
\begin{array}{c}
\min_{\lambda} \frac{1}{2} \| \boldsymbol{y}_V - \boldsymbol{X}_V \hat{\boldsymbol{\theta}} (\lambda) \| ^2 \\
\text{ where }
...
\begin{equation}
\begin{array}{c}
\min_{\lambda} \frac{1}{2} \| \boldsymbol{y}_V - \boldsymbol{X}_V U_\lambda \hat{\boldsymbol{\beta}} (\lambda) \| ^2 \\
\text{ where }
...
\begin{equation}
\begin{bmatrix}
\nabla_{\lambda_1} \hat {\boldsymbol \eta} (\boldsymbol \lambda) & \nabla_{\lambda_2} \hat {\boldsymbol \eta} (\boldsymbol \lambda) \\
\nabla_{\lambda_1} \hat {\boldsymbol \theta} (\boldsymbol \lambda) & \nabla_{\lambda_2} \hat {\boldsymbol \theta} (\boldsymbol \lambda)
\end{bmatrix}
=
-
\begin{bmatrix}
...
\end{bmatrix}^{-1}
\begin{bmatrix}
sgn \left ( {\boldsymbol \eta} (\boldsymbol \lambda) \right ) & \vec{0}\\
\vec{0} & D^T(\boldsymbol z) D(\boldsymbol z) \boldsymbol \theta (\boldsymbol \lambda)
\end{bmatrix}
\end{equation}
%
%\begin{equation*}
...
\label{alg:accGradDescent}
	...
	\item[] Perform Neterov's update with step size $t^{(k)}$:
              \begin{equation}
                \begin{array}{lcl}
                \boldsymbol{\eta} & := &
          ...
          \item[] If the function value increases
          \begin{equation}
          ...
          \end{equation}
          restart by setting iteration $k := 0$ with initialization
                  \begin{equation}
                  \boldsymbol{\lambda}^{(0)} := \boldsymbol{\lambda}^{(k)}
                  \end{equation}
          \end{itemize}
          \end{itemize}
\end{algorithm}
...
\begin{equation}
\sum_{j=1}^m \lambda_1^{(j)} \| \beta^{(j)} \|_2
+ \lambda_2 \| \beta \|_1
\label{unpooledSGL}
\end{equation}
...
\begin{equation}
\lambda_1 \| \beta \|_1
+ \frac{1}{2} \lambda_2 \| \beta \|_2^2
+ \frac{1}{2} \lambda_3 \| D^{(2)} \theta \|_2^2
\end{equation}
...
\begin{multline}
\min_{\lambda_1, \lambda_2, \lambda_3} \frac{1}{2} \left \| \boldsymbol y_V - X_V\hat\beta - M_V \hat\theta \right \|^2_2 \\
\text{ where } \hat\beta, \hat\theta = \argmin_{\beta, \theta} \frac{1}{2} \left \| y - X\beta - M_T \theta \right \|^2_2
+ \lambda_1 \| \beta \|_1
+ \frac{1}{2} \lambda_2 \| \beta \|_2^2
+ \frac{1}{2} \lambda_3 \| D^{(2)} \theta \|_2^2
\end{multline}
