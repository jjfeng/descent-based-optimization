...
\end{equation}
and is positive definite. Details for matrices $\boldsymbol{M}_1(\boldsymbol\lambda)$ and $\boldsymbol{M}_2(\boldsymbol\lambda)$ are given in the Appendix. \hfill \ding{51}
\end{itemize}
...
\begin{center}
  \fbox{
	...
	\begin{itemize}
              ...
              \end{equation*}
              \item[] Set $\boldsymbol{\lambda}^{(0)} = \boldsymbol{\lambda}^{(k)}$ and $k= 0$.
	\end{itemize}
    }
  }\\
