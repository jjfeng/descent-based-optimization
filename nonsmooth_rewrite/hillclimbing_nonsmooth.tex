...
\begin{table}
	...
	\centering
		...
		% new running: script_out/matrix_completion_groups_HC_11.out
		...
		% new running: script_out/matrix_completion_groups_GS_11.out
		...
		\hline
		% rerunning on bayes: script_out/matrix_completion_groups_GS_9.out
