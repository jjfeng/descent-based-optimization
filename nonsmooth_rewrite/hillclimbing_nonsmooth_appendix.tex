...
\begin{table}
	...
	\begin{tabular}{| l | l | l | l | l | l |}
		...
		\hline
		% running on aws 52.24.225.23
		% results/matrix_completion_groups/matrix_completion_groups_HC0_11.txt
		GD & 2 &  \\
		\hline
		...
		& \# $\lambda$ & Validation Err & Test Err&  $\Gamma$ Rank & Num Solves\\
		\hline
		% launching on my other aws instance 35.167.141.133
		% results/matrix_completion_groups/matrix_completion_groups_HC0_9.txt
		GD & 2 & ?\\
		\hline
